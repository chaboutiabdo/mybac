...
// Lazy like the rest: its daily-question card pulls in KaTeX, which the
// landing page (the public first load) shouldn't have to download.
          ...
          <BrowserRouter>
            <Routes>
              ...
              {/* Flat, matching the only two list->detail pairs in the app
                  ...
                  the real gate and enforces premium server-side. */}
              ...
              {/* Premium: every deck is private and only premium students can
                  generate one (gemini-chat), so a free student would only
                  ever see an empty page. */}
